...
//# of unfunded games = length of list of unfunded games
let numUnfundedGames = listOfUnfundedGames.length;

// create a string that explains the number of unfunded games using the ternary operator
let descriptionStr = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for 
${GAMES_JSON.length} games. Currently, ${numUnfundedGames} ${numUnfundedGames > 1 ? 'games remain' : 'game remains'} unfunded.
We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const description = document.createElement('div');
description.innerHTML = `<p>${descriptionStr}</p>`;
...
let secondMostPledgedGame = document.createElement('div');
secondMostPledgedGame.innerHTML = `<p>${runnerUpGame.name}</p>`;
